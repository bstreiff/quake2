...
#pragma warning(disable : 4127)		// conditional expression is constant (typically: 'while (1)')
#pragma warning(disable : 4706)		// assignment within conditional expression (while ((t = NextThing())) {} )
